...
import CalendarCss from "./_Calendar.module.scss";
...
const Calendar = ({ handleWorkTimeData,setSelectedDate,setCalendarShow,calendarShow }) => {
  ...
  return (
    <div className={CalendarCss.calendar}>
      <div className={CalendarCss.calendarHeader}>
      ...
      <div className={CalendarCss.days}>
        {daysArray.map((day, index) =>
          day === null ? (
            ...
            <div
              key={index}
              className={`${CalendarCss.day} ${day === today.getDate() && year === today.getFullYear() && month === today.getMonth() ? CalendarCss.today : ""}`}
